...
data = dict(
    samples_per_gpu=128,
    workers_per_gpu=8,
    train=dict(imgs_root='/nfs/home/daft69828/mmgeneration/data/modified_dataset/dark_color_point'),
    val=dict(imgs_root='/nfs/home/daft69828/mmgeneration/data/modified_dataset/dark_color_point')
)
...
evaluation = dict(
    ...
    metrics=dict(
        type='FID',
        num_images=7886,
        inception_pkl='/nfs/home/daft69828/mmgeneration/work_dirs/inception_pkl/IS_stylegan_black.pkl',
        inception_args=dict(
            type='StyleGAN',
