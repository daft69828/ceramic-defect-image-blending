...
salobj_dataset = SalObjDataset(
    ...
    transform=transforms.Compose([
        ...
        RandomCrop(224),
        ToTensorLab(flag=0)]))
salobj_dataloader = DataLoader(salobj_dataset, batch_size=batch_size_train, shuffle=False, num_workers=1)
...
Resume = True
    # Resume = False
if Resume:
        path_checkpoint = '/home/wang/BASNet/saved_models/basnet_bsi/basnet_bsi_itr_110000_train_0.237505_tar_0.000824.pth'
