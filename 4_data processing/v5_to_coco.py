...
coco_format_save_path='./v5_to_coco/save_path/val_2584/'                      #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='./v5_to_coco/type_names.txt'     #类别文件，一行一个类
yolo_format_annotation_path='../poisson_image_editing/dataset_for_detection_0.4/val/val_res_labs/'        #yolo格式标签所在文件夹
img_pathDir='../poisson_image_editing/dataset_for_detection_0.4/val/val_res_imgs/'                        #图片所在文件夹

if not os.path.exists(coco_format_save_path): os.makedirs(coco_format_save_path)
